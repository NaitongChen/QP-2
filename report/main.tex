...
\title{Qualifying Paper Report for Estimation of High Dimensional Mean Regression
in the Absence of Symmetry and Light Tail Assumptions} % replace with your title, a meaningful title
...
\include{sections/new\_simulation}
